...
<head>
    ...
    <title>Akademi Komunitas Negeri Seni dan Budaya</title>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="<?= base_url('assets_admin/') ?>dist/css/adminlte.css">
    <!-- overlayScrollbars -->
    <link rel="stylesheet" href="<?= base_url('assets_admin/') ?>plugins/overlayScrollbars/css/OverlayScrollbars.css">
    <!-- Daterange picker -->
