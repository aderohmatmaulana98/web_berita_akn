...
<head>
    ...
    <!--Favicon-->
    <link rel="shortcut icon" href="<?= base_url('assets/images/akn/logo_hitam.png'); ?>" type="<?= base_url('assets/images/akn/logo_akn_tulisan_putih.png') ?>">
    <link rel="icon" href="<?= base_url('assets/images/akn/logo_hitam.png'); ?>" type="<?= base_url('assets/image/x-icon') ?>">
    <!-- Responsive -->
            ...
            <div class="sticky-header">
                <div class="auto-container clearfix">
                    ...
                    <div class="logo pull-left">
                        <a href="index.html" class="img-responsive"><img src="<?= base_url('assets/images/akn/logo_akn_tulisan_hitam.png') ?>" width="200px" height="70px" alt="Brighton" title="Brighton"></a>
                    </div>
