    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <div class="mb-3">
                    <img class="mx-auto d-block" src="<?= base_url('assets_admin/img/logo_akn.png') ?>" width="100" alt="">
                </div>
                <h5 class="text-uppercase text-center"><b>Akademi Komunitas Negeri Seni dan Budaya Yogyakarta</b></h5>
                ...
                <form action="<?= base_url('auth/index') ?>" method="post">
                    ...
                    <div class="mb-3">
                        <div class="input-group">
                            <input type="password" name="password" id="password" class="form-control" <?= set_value('password') ?> placeholder="Password">
                            <div class="input-group-append">
                                <div class="input-group-text">
                ...
                <hr>
                <div>
                    <p class="text-center"><small>Copyright 2022 <br>Akademi Komunitas Negeri Seni dan Budaya Yogyakarta
