                ...
                <div class="card card-primary card-outline">
                    <div class="card-header row">
                        ...
                        <div class="col-6 text-white text-right">
                            <a href="<?= base_url('admin/list_artikel') ?>" class="btn btn-primary">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('admin/aksi_ubah_artikel'); ?>" method="POST"
                            enctype="multipart/form-data">
                            <div class="form-group row">
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="id" name="id"
                                        value="<?= $ubah_artikel['id']; ?>" hidden>
                                </div>

                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="judul" name="judul"
                                        value="<?= $ubah_artikel['judul']; ?>" required>
                                </div>
                ...
                <div class="col">
                    <div class="card card-primary card-outline mr-1">
                        ...
                        <div class="card-body">
                            ...
                            <textarea name="isi_konten" id="editor3"><?= $ubah_artikel['isi_konten'] ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select name="tipe_tulisan" class="custom-select" id="tipe_tulisan"
                                    value="<?= $ubah_artikel['tipe_tulisan']; ?>" disabled>
                            ...
                            <div class="form-group">
                                ...
                                <select name="kategori" class="custom-select" required>
                                    ...
                                    <option <?= ($k['id'] == $ubah_artikel['id_kategori']) ? 'selected' : '' ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type='file' id="gambar" name="gambar" onchange="pressed()"
                                    ...
                                    id="fileLabel"><?= $ubah_artikel['gambar'] ?></label> <br>
                                <img class="mt-3"
                                    src="<?= base_url('assets_admin/img/artikel/') . $ubah_artikel['gambar'] ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <select class="form-select" name="status_tulisan" id="status_tulisan"
                                        ...
                                        <option <?php if ($ubah_artikel['status_tulisan'] == 'Pending') {
													echo 'selected';
												} ?> value="Pending">Pending</option>
                                        <option <?php if ($ubah_artikel['status_tulisan'] == 'Publish') {
													echo 'selected';
												} ?> value="Publish">Publish</option>
                                        <option <?php if ($ubah_artikel['status_tulisan'] == 'Draft') {
													echo 'selected';
