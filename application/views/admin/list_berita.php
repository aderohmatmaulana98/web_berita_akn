                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    foreach ($berita as $b) : ?>
                                        <tr>
                                            <td><?= $i; ?></td>
                                            <td><img src="<?= base_url('assets_admin/img/berita/') . $b['gambar']; ?>" alt="" srcset="" height="50" width="50"></td>
                                            <td><?= $b['judul']; ?></td>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url('admin/ubah_berita/') . $b['id'] ?>" class="badge badge-success">Ubah</a>

                                                <a href="<?php echo base_url('admin/hapus_berita/') . $b['id'] ?>" class="badge badge-danger" onclick="return confirm ('Hapus daftar?')">Delete</a>
                                            </td>
                                        </tr>
                                        <?php $i++;  ?>
                                    <?php endforeach; ?>
