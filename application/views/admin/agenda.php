                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?= base_url('admin/add_agenda'); ?>" method="POST"
                                            enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label for="nama_agenda">Nama Agenda</label>
                                                <input type="text" class="form-control" id="nama_agenda"
                                                    name="nama_agenda">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="keterangan" id="keterangan"
                                                    name="keterangan" cols="30" rows="10"></textarea>
                                            </div>
                                            <div class="form-group">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $a['waktu']; ?></td>
                                    <td><?= $a['keterangan']; ?></td>
                                    <td><img src="<?= base_url('assets_admin/img/agenda/') . $a['gambar']; ?>" alt=""
                                    ...
                                    <td>
                                        <!-- <a href="#" class="badge badge-pill badge-success" data-toggle="modal"
                                            ...
                                            Edit</a> -->
                                        <a href="#" class="badge badge-pill badge-success" data-toggle="modal"
                                            data-target="#editexample<?= $a['id']; ?>"><i class="fas fa-edit"></i>
                                            Edit</a>

                                        <!-- Modal -->
                                        <div class="modal fade" id="editexample<?= $a['id']; ?>"
                                            aria-labelledby="editexampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content col-lg-12">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="editexampleModalLabel">Ubah
                                                            Pengumuman</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="<?= base_url('admin/ubah_agenda'); ?>"
                                                            method="POST" enctype="multipart/form-data">
                                                            <div class="form-group">
                                                                <label for="nama_agenda" class="form-label">Nama
                                                                    Agenda</label>
                                                                <input type="text" class="form-control" id="nama_agenda"
                                                                    name="nama_agenda" value="<?= $a['nama_agenda']; ?>"
                                                                    required>
                                                                <input type="text" class="form-control" id="id"
                                                                    name="id" value="<?= $a['id']; ?>" hidden required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="deskripsi">Deskripsi</label>
                                                                <textarea class="form-control" name="deskripsi"
                                                                    id="deskripsi" name="deskripsi"
                                                                    value="<?= $a['deskripsi']; ?>" cols="30"
                                                                    rows="10"><?= $a['deskripsi'] ?></textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="mulai">Mulai</label>
                                                                <input type="date" class="form-control" id="mulai"
                                                                    name="mulai" value="<?= $a['mulai']; ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="selesai">Selesai</label>
                                                                <input type="date" class="form-control" id="selesai"
                                                                    name="selesai" value="<?= $a['selesai']; ?>">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="tempat">Tempat</label>
                                                                <input type="text" class="form-control" id="tempat"
                                                                    name="tempat" value="<?= $a['tempat']; ?>">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="waktu">Waktu</label>
                                                                <input type="time" class="form-control" id="waktu"
                                                                    name="waktu" value="<?= $a['waktu']; ?>">
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" name="keterangan"
                                                                    ...
                                                                    value="<?= $a['keterangan']; ?>" cols="30"
                                                                    rows="10"><?= $a['keterangan'] ?></textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="gambar">Gambar</label>
                                                                <input type="file" class="form-control" id="gambar"
                                                                    name="gambar" value="<?= $a['gambar']; ?>">
                                                            </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary"
                                        ...
                                        <a href="<?php echo base_url('admin/hapus_agenda/') . $a['id'] ?>"
                                            class="badge badge-danger"
                                            onclick="return confirm ('Hapus daftar?')">Hapus</a>
                                    </td>
                                </tr>
                                <?php $i++;
                                endforeach; ?>
