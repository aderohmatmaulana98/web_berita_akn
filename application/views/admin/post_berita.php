        ...
        <div class="container-fluid">
            ...
            <div class="col-lg">
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('admin/add_post_berita') ?>" method="POST" enctype="multipart/form-data">
                            <div class="form-group row">
                                <div class="col-lg-10">
                                    <input type="text" name="judul" class="form-control" placeholder="Judul Postingan" aria-label="Judul Postingan" aria-describedby="button-addon2">
                                </div>
                                <div class="col">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select name="tipe_tulisan" class="custom-select" id="tipe_tulisan" value="Berita" disabled>
                            ...
                            <div class="form-group">
                                ...
                                <input name="gambar" type="file" class="form-control" id="gambar" class="form-control" name="gambar">
                            </div>
                            <!-- <div class="form-group">
