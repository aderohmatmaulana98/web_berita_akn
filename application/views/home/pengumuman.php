                            ...
                            <div class="inner-box">
                                <figure class="image">
                                    <a href="blog-details.html"><img
                                            src="<?= base_url('./assets_admin/img/thumbnail_pengumuman/') . $art['gambar_thumbnail'];  ?>"
                                ...
                                <div class="lower-content">
                                    <h3><a
                                            href="<?php echo base_url('home/detailpegumuman/') . $art['id'] ?>"><?= substr($art['judul'], 0, 20); ?>...</a>
                                    </h3>
                                    ...
                                    <div class="textku">
                                        <p><?= substr($art['konten_pengumuman'], 0, 50); ?>...</p>
                                    </div>
                                    <a class="read-more col-mb-4"
                                        href="<?php echo base_url('home/detailpengumuman/') . $art['id'] ?>">READ MORE
