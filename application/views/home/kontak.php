        ...
        <div class="row clearfix">
            <div class="column col-md-4 col-sm-6 col-xs-12">
                <div class="info-box wow zoomInStable" data-wow-delay="0ms" data-wow-duration="1500ms">
                    ...
                    <h3>Akademi Komunitas Negeri Seni dan Budaya Yogyakarta</h3>
                    <div class="text">Kantor: Jl. Parangtritis No.364, Pandes,<br> Panggungharjo, Kec. Sewon,
                        Bantul,<br> Daerah Istimewa Yogyakarta 55188</div>
                </div>
            </div>
            ...
            <div class="column col-md-4 col-sm-6 col-xs-12">
                <div class="info-box wow zoomInStable" data-wow-delay="1000ms" data-wow-duration="1500ms">
                    ...
                    <h3>No.Telp</h3>
                    <div class="text"> (+62)81348000045</div>
                </div>
            </div>
        </div>
    </div>
